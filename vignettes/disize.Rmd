...
Although there are some similarities, there are enough differences that using
the most granular definition is likely better at adjusting for batch-effects.
