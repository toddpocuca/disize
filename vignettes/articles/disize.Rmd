...
> **Note**: `disize` encourages users to set the `n_threads` argument in order to take advantage of parallelization. Experiment with different values of `n_threads` to find the best performance for your dataset.
