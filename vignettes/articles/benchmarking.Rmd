...
plot_benchmark <- function(benchmark, title, design_formula) {
    the_plot <- ggplot(benchmark, aes(x = sd, fill = comparison)) +
        ...
        labs(
            ...
            x = "Biological Variation (Nonsparse Standard Deviation)", 
            y = "Relative % Increase in Error") +
        theme_classic()
...
sim_pars <- expand.grid(
    "n_genes" = c(10000L),
    "sparsity" = c(0.10, 0.50, 0.90),
    "sd" = c(0.25, 0.50, 1.0, 2.0)
) |>
