...
instead you have to go inspecting the methods section or even contacting the authors for how samples were processed (if samples were prepared on the same day with the same reagents, where library pooling was done, were multiple sequencing runs were used, etc).
